@echo off
:: Исходная папка
set "SOURCE=C:\Users\Nichita Sviridcenko\Desktop\Signatures_backup\v"

:: Папка назначения
set "DEST=C:\Users\Nichita Sviridcenko\Zomboid\Workshop\Check-the-Papers\Contents\mods\Check-the-Papers\42\media\textures\signatures\v"
